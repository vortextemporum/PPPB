...
function addPerformers(ply) 
    for groups = 1, 16, 1 do
        for people = 1, 4, 1 do
            local notestart = 24 * (people - 1) + 12
            -- newbot = {}
...
-- e.g, vanilla_weapons, hl_weapons
local all_weapons = {
    "weapon_crowbar",
    "weapon_stunstick",
    "weapon_pistol",
...
function commandshit(newbot, cmd)
    ...
    for k, weapon in pairs(all_weapons) do
    ...
    if(IsValid(performer.Owner)) then
        ...
        for groups = 1, 16, 1 do
            for people = 1, 4, 1 do
                ...
                -- print(val)
                for num, wep in pairs(all_weapons) do 
                ...
                for num, pm in pairs(all_playermodels) do 
